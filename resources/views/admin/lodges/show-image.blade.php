...
<div class="main-content bg-gray-100 h-100">
    <div class="container-fluid">
        <div class="d-flex flex-row justify-content-between">
            <div>
                <h5 class="mb-0">Manage {{ $lodge->name }} Images</h5>
            </div>
            {{-- Back Button --}}

            <form action="{{ route('lodges.store-image', $lodge->id) }}" method="POST" enctype="multipart/form-data">
                <a href="{{ route('lodges.edit', $lodge->slug) }}" class="btn bg-gradient-secondary btn-sm mx-2">
                    {{ __('Back') }}
                </a>
                @csrf
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-footer text-center">
                            <form action="{{ route('lodges.destroy-image', $image->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
