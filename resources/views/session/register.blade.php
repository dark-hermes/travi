      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Welcome to Travi!</h1>
            <p class="text-lead text-white">Tired of the same old travel routine? Let us help you discover new villages!</p>
          </div>
        </div>
      </div>
    </div>
